...
void application_start( void )
{
    ...
    resource_get_readonly_buffer( &resources_apps_DIR_scu_mqtt_server_DIR_rootca_cer, 0, MQTT_MAX_RESOURCE_SIZE, &size_out, (const void **) &security.ca_cert );
